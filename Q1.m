...
for i = 1:30
    data1 = [x_raw; y_raw; z_raw(i,:)];
    [model_temp, rmse_temp] = trainRegressionModel(data1);
    yfit_temp = model_temp.predictFcn([x_raw; y_raw])';
    
    rmse_result = [rmse_result; rmse_temp];
    model_result{i} = model_temp;
    yfit_result = [yfit_result; yfit_temp];
end

diff_result = z_raw - yfit_result;
csvwrite('z_predicted.csv',yfit_result);
...
% Auto-generated by MATLAB on 2020-10-19 07:28:08
