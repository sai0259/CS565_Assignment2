...
data = [x; y; z];
[model_temp, rmse_temp] = trainRegressionModel(data);
yfit_temp = model_temp.predictFcn([x; y])';
yfit_result = reshape(yfit_temp,30,30);
